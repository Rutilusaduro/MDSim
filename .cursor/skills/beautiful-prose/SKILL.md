...
- **This repo:** All narrative strings in `src/characters.js`, `src/events.js`, and related UI copy.
...
Sensual body descriptions and dialogue use concrete physical detail. No em dashes. No filler pivots.
...
- `src/prose.js` exports `lintProse()` and game register defaults.
- Run `npm run lint:prose` before shipping narrative changes.
